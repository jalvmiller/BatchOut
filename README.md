...
<div align="center">
O <b>BatchOut</b> é uma plataforma corporativa para gestão e exportação assíncrona de relatórios de despesas de grande volume.<br><br> <i>É um projeto pessoal que uso para fixar conhecimento relacionado a solução de problemas de performance em sistemas de grande porte. <br><br>Tenho a intenção de continuar implementando mais funções ligadas ao backend, já que é a área de Web que mais gosto de estudar. Eventualmente irei trazer uma interface web, mas o uso é feito via Swagger neste momento.<i><br>
